    ...
    const handleSavePermissions = async () => {
        ...
        try {
            ...
            toast.show({
                ...
                message: "Operasi ditolak. Anda tidak memiliki izin untuk memberikan hak yang Anda sendiri tidak miliki.",
            });
        } finally {
            setIsSubmitting(false);
        }
    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                        Definisikan peran sistem (RBAC) dan atur matriks izin yang diperbolehkan untuk setiap tingkatan pengguna.
                    </p>
                </div>
            ...
            <div className="p-3.5 bg-blue-50 border border-blue-200 rounded-xl flex items-center gap-3 text-xs text-blue-900">
                ...
                <div>
                    <strong>Aturan Privilege Escalation (Rule B01/REV-PERM-01):</strong> Anda hanya
                    dapat memberikan izin kepada peran lain sejauh izin tersebut dimiliki oleh akun Anda.
                    Izin di luar wewenang Anda akan otomatis dinonaktifkan.
                </div>
            </div>
                            ...
                            <div key={resource} className="border border-gray-200 rounded-xl p-3 bg-gray-50/50">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    {perms.map((p) => {
                                        ...
                                        const userHasPerm =
                                            isSuperAdmin || can(p.name as any);
                                        const isChecked = selectedPermIds.includes(p.id);

                                        return (
                                            <label
                                                key={p.id}
                                                className={`flex items-start gap-2 p-2 rounded-lg border text-xs transition ${!userHasPerm
                                                ...
                                                title={
                                                    !userHasPerm
                                                        ? "Anda tidak bisa memberikan izin yang tidak Anda miliki."
                                                        : undefined
                                                }
                                            >
                                                <input
