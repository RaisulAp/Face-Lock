        ...
        <div className="space-y-6">
            ...
            <div className="flex border-b border-gray-200">
                <button
                    ...
                    className={`px-4 py-2.5 text-xs font-semibold border-b-2 cursor-pointer transition-colors ${activeTab === "summary"
                ...
                <button
                    ...
                    className={`px-4 py-2.5 text-xs font-semibold border-b-2 cursor-pointer transition-colors ${activeTab === "export"
                            ? "border-indigo-600 text-indigo-600"
                            : "border-transparent text-gray-500 hover:text-gray-900"
                        }`}
                >
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs text-gray-400">
                                {previewAttendances.length} baris ditampilkan
                            </span>
                        </div>
