    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mt-0.5">
          Audit telemetri setiap percobaan check-in/check-out oleh karyawan, kegagalan pencocokan wajah, dan
          anomali lokasi.
        </p>
      </div>
      ...
      <Card>
        <CardContent className="py-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div>
              <label className="block text-[10px] font-semibold text-gray-500 mb-1">Tipe Presensi</label>
              <select
                value={type}
                onChange={(e) => {
            ...
            <div>
              <label className="block text-[10px] font-semibold text-gray-500 mb-1">Dari Tanggal</label>
              <Input
                type="date"
                value={startDate}
                onChange={(e) => {
            ...
            <div>
              <label className="block text-[10px] font-semibold text-gray-500 mb-1">Sampai Tanggal</label>
              <Input
                type="date"
                value={endDate}
                onChange={(e) => {
        ...
        <CardContent className="p-0">
                ...
                {isLoading ? (
                  ...
                  attemptsRes.data.map((att) => (
                    <tr key={att.id} className="hover:bg-gray-50/50">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">{getOutcomeBadge(att.outcome)}</td>
          ...
          {attemptsRes?.meta && attemptsRes.meta.total_pages > 1 && (
            <div className="p-4 border-t border-gray-100">
              <Pagination page={page} totalPages={attemptsRes.meta.total_pages} onPageChange={setPage} />
            </div>
          )}
        </CardContent>
      </Card>
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-100 space-y-1">
                ...
                <div className="text-gray-700">
                  Model AI: <strong className="font-mono">{selectedAttempt.model_version || "—"}</strong>
                </div>
                <div className="text-gray-700">
                  Skor Kualitas: <strong>{selectedAttempt.quality_score ?? "—"}</strong>
                </div>
              </div>
              ...
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-100 space-y-1">
                ...
                <div className="text-gray-700">
                  Fallback Diizinkan: <strong>{selectedAttempt.allow_fallback ? "Ya" : "Tidak"}</strong>
                </div>
              </div>
            </div>
