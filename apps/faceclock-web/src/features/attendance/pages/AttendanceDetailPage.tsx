                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3 text-xs">
                            <div className="flex justify-between py-1 border-b border-gray-100">
                                ...
                                <LocalTime value={attendance.recorded_at} format="datetime" className="font-semibold text-gray-900" />
                            </div>

                            <div className="flex justify-between py-1 border-b border-gray-100">
                                <span className="text-gray-500">Tipe Absen:</span>
                                <span className="font-semibold text-gray-900 capitalize">{attendance.check_type || "Masuk"}</span>
                            </div>

                            <div className="flex justify-between py-1 border-b border-gray-100">
                                <span className="text-gray-500">Metode Verifikasi:</span>
                                <span className="font-semibold text-gray-900 capitalize">{attendance.verification_mode || "Face"}</span>
                            </div>
                            ...
                            {attendance.reviewed_at && (
                                <div className="flex justify-between py-1 border-b border-gray-100 bg-amber-50/50 px-2 rounded">
                                    ...
                                    <LocalTime value={attendance.reviewed_at} format="datetime" className="font-semibold text-amber-900" />
                                </div>
                            )}
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                <GeofenceBadge isWithin={attendance.is_within_geofence} distanceMeters={attendance.distance_meters} />
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[11px] text-gray-500 pt-1">
                                ...
                                <div>
                                    ...
                                    <p className="font-mono text-gray-800">
                                        {attendance.distance_meters != null ? `${Math.round(attendance.distance_meters)} meter` : "-"}
                                    </p>
                                </div>
                            </div>
                        </CardContent>
