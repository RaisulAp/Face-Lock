...
export function AuditLogsPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <Card>
        <CardContent className="py-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            <div>
              <label className="block text-[10px] font-semibold text-gray-500 mb-1">Aksi (Action)</label>
              <Input
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xs">Daftar Jejak Audit ({logsRes?.meta?.total || 0})</CardTitle>
        </CardHeader>
        <CardContent className="p-0">
          ...
          {logsRes?.meta && logsRes.meta.total_pages > 1 && (
            <div className="p-4 border-t border-gray-100">
              <Pagination page={page} totalPages={logsRes.meta.total_pages} onPageChange={setPage} />
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Modal open={detailOpen} onClose={() => setDetailOpen(false)} title="Detail Aktivitas Audit Log">
        {selectedLog && (
          <div className="space-y-4 text-xs">
            ...
            <div>
              ...
              <pre className="p-3 bg-gray-900 text-gray-100 rounded-xl overflow-x-auto text-[11px] font-mono leading-relaxed max-h-60">
                {JSON.stringify(selectedLog.metadata || selectedLog.payload || {}, null, 2)}
              </pre>
            </div>
