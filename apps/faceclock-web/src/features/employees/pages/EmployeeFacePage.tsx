            ...
            <div className="flex items-center gap-3">
                <Link to="/employees">
                    <Button variant="outline" size="sm">
                        <ArrowLeft className="w-4 h-4 mr-1" /> Kembali ke Karyawan
                    </Button>
                </Link>
                <div>
                    <h1 className="text-xl font-bold text-gray-900">
                        Biometrik Wajah: {employee?.name || "Karyawan"}
                    </h1>
                    <p className="text-xs text-gray-500 mt-0.5">
                        Kelola template embedding wajah dan foto referensi absensi.
                    </p>
                </div>
            </div>
                        ...
                        {isFaceLoading ? (
                            ...
                            <div className="aspect-square rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 flex flex-col items-center justify-center p-6 text-center">
                                ...
                                <p className="text-[11px] text-gray-400 mt-1 leading-relaxed">
                                    Karyawan ini belum memiliki pendaftaran template wajah. Pendaftaran mandiri
                                    dapat dilakukan lewat portal absensi.
                                </p>
                            </div>
                        )}
                    </CardContent>
                        ...
                        <Card className="border-rose-200 bg-rose-50/30">
                            <CardContent className="p-4 space-y-2">
                                ...
                                <p className="text-[11px] text-rose-600 leading-relaxed">
                                    Menghapus template wajah akan membuat karyawan tidak dapat melakukan absensi
                                    pengenalan wajah sampai dilakukan pendaftaran ulang.
                                </p>
                                <Button
                                    variant="danger"
                                    size="sm"
