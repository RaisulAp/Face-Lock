...
export function SettingsPage() {
  ...
  const checkConsequenceAndSave = (key: string, newValue: unknown) => {
    ...
    if (
      key === "attendance.allow_fallback_without_enrollment" &&
    ...
    <div className="space-y-8 max-w-5xl mx-auto pb-12">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    checkConsequenceAndSave("face.min_quality_score", formValues["face.min_quality_score"])
                  }
                >
                  <Save className="w-3.5 h-3.5" />
                </Button>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Select
                  ...
                  onChange={(e) => handleChange("face.consent_required", e.target.value === "true")}
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    checkConsequenceAndSave("face.consent_required", formValues["face.consent_required"])
                  }
                >
                  <Save className="w-3.5 h-3.5" />
                </Button>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Select
                  ...
                  onChange={(e) => handleChange("face.duplicate_check_enabled", e.target.value === "true")}
                >
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Select
                  ...
                  onChange={(e) => handleChange("attendance.geofence_enabled", e.target.value === "true")}
                >
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Select
                  ...
                  onChange={(e) => handleChange("attendance.outside_geofence_policy", e.target.value)}
                >
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  onChange={(e) => handleChange("attendance.max_gps_accuracy_meter", Number(e.target.value))}
                />
                <Button
                  variant="outline"
                  size="sm"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">Zona Waktu (Timezone)</label>
              <div className="flex items-center gap-2">
                <Select
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Select
                  ...
                  onChange={(e) =>
                    handleChange("attendance.allow_fallback_without_enrollment", e.target.value === "true")
                  }
                >
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("attendance.max_failed_attempts_per_hour", Number(e.target.value))
                  }
                />
                <Button
                  variant="outline"
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  onChange={(e) => handleChange("attendance.photo_retention_days", Number(e.target.value))}
                />
                <Button
                  variant="outline"
                  size="sm"
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  onChange={(e) => handleChange("face.retention_days_after_resign", Number(e.target.value))}
                />
                <Button
                  variant="outline"
                  size="sm"
      ...
      <Card className="border-indigo-200">
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => refetchQuality()} disabled={isQualityFetching}>
        ...
        <CardContent className="space-y-4">
          <p className="text-xs text-gray-500 leading-relaxed">
            Ambang batas kualitas di bawah ini bersumber langsung dari kontainer inferensi AI. Nilai di
            database (<em>app_settings</em>) dibandingkan secara live terhadap nilai aktif di engine. Baris
            yang tidak sinkron menandakan container inference perlu disinkronkan.
          </p>
          ...
          {isQualityLoading ? (
            ...
            <div className="p-3.5 bg-gray-50 rounded-xl border border-gray-200 flex items-center gap-3 text-xs text-gray-600">
              ...
              <span>
                Kontainer inferensi tidak merespons (<em>checked_at: null</em>). Pastikan service face-engine
                sedang berjalan.
              </span>
            </div>
          ) : (
                  ...
                  {qualityStatus.thresholds?.map((item) => {
                    ...
                    return (
                      <tr key={item.key} className={isSynced ? "" : "bg-amber-50/40"}>
                        <td className="px-3.5 py-2.5 font-sans font-medium text-gray-800">{item.key}</td>
